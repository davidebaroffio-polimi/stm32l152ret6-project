 ...
 */
__attribute__((annotate("include"))) uint64_t des(uint64_t input, uint64_t key, char mode) {
...
__attribute__((annotate("include"))) void testDES() {
